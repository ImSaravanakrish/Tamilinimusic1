...
API_ID = int(getenv("API_ID", "27133037"))
API_HASH = getenv("API_HASH", "2edf959682b4f5d90790f307075ba1fc")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/iamproaf/believersmusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/TamilBots")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Tamilsupport")
